...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:\\Users\\Asus\\Desktop\\PP2-2025\\lab8\\race\\Enemy.png") # загружаем картинку
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:\\Users\\Asus\\Desktop\\PP2-2025\\lab8\\race\\Player.png") # загружаем картинку
        self.rect = self.image.get_rect()
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load("C:\\Users\\Asus\\Desktop\\PP2-2025\\lab8\\race\\coin.png") # загружаем картинку
        self.rect = self.image.get_rect()
